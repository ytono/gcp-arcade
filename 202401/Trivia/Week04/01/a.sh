...
read -p "Cloud SQL IP: " CLOUDSQLIP
...
gcloud compute scp index.php bloghost:/tmp/index.php
gcloud compute ssh bloghost --command "sudo cp /tmp/index.php /var/www/html/index.php; sudo service apache2 restart"
